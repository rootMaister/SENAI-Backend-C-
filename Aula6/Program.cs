...
namespace Aula6 {
    class Program {
        static void Main (string[] args) {
            //Chamammos nossa primeira função
        ...
        /// <summary>
        /// Retorna um número - Teste de Sobrecarta
        /// </summary>
        ...
        static double CalculaMedia (double[] valores) {
            ...
            for (int bat = 0; bat < valores.Length; bat++) {
                resultado += valores[bat];
            }
        ...
        /// <summary>
        /// Soma valores de um vetor
        /// </summary>
        /// <param name="valores">Soma os valores de um vetor</param>
        /// <returns></returns>
